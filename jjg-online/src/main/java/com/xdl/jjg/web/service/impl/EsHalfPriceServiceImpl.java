...
import com.shopx.trade.api.message.CartPromotionChangeMsg;
import com.shopx.trade.api.model.domain.ESGoodsSkuSelectDO;
...
import com.shopx.trade.api.model.domain.vo.EsHalfPriceVO;
import com.shopx.trade.api.model.enums.PromotionTypeEnum;
import com.shopx.trade.api.service.IEsHalfPriceService;
import com.shopx.trade.api.service.IEsPromotionGoodsService;
import com.shopx.trade.dao.entity.EsHalfPrice;
import com.shopx.trade.dao.mapper.EsHalfPriceMapper;
import com.shopx.trade.service.job.ResponseEntityMsg;
import com.shopx.trade.service.job.execute.XXLHttpClient;
import com.shopx.trade.service.plugin.PromotionValid;
 ...
 */
@Service(version = "${dubbo.application.version}", interfaceClass = IEsHalfPriceService.class, timeout = 50000)
