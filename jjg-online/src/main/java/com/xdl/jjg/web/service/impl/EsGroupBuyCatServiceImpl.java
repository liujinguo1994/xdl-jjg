...
import com.shopx.trade.api.model.domain.EsGroupBuyCatDO;
import com.shopx.trade.api.model.domain.dto.EsGroupBuyCatDTO;
import com.shopx.trade.api.service.IEsGroupBuyCatService;
import com.shopx.trade.dao.entity.EsGroupBuyCat;
import com.shopx.trade.dao.mapper.EsGroupBuyCatMapper;
 ...
 */
@Service(version = "${dubbo.application.version}", interfaceClass = IEsGroupBuyCatService.class, timeout = 50000)
