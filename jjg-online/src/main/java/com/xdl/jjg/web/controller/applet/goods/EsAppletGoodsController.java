 ...
 */
@Api(value = "/applet/goods/goods",tags = "小程序-商品")
@RestController
@RequestMapping("/applet/goods/goods")
public class EsAppletGoodsController {
    ...
    public ApiResponse getGoodsSkuList(@PathVariable Long goodsId) {
        ...
        if (result.isSuccess()) {
            ...
            for (EsBuyerGoodsParamsDO goodsParams:paramsList) {
