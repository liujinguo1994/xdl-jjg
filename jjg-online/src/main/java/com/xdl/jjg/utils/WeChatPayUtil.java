...
//        String unionId = (String) ThreadContextHolder.getHttpRequest().getSession().getAttribute(WeChatPluginConfig.UNIONID_SESSION_KEY);
...
//        String openid = (String) ThreadContextHolder.getHttpRequest().getSession().getAttribute(WeChatPluginConfig.OPENID_SESSION_KEY);
