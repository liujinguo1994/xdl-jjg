 ...
 * @date 2019/8/12 9:49
 */
public class WeixinAppOauth2Template extends OAuth2Template {
     ...
     */
    public WeixinAppOauth2Template(String clientId, String clientSecret, String authorizeUrl, String accessTokenUrl) {
    ...
    public String buildAuthenticateUrl(OAuth2Parameters parameters) {
        ...
        url = url + "&appid=" + clientId + "&scope=snsapi_userinfo#wechat_redirect";
