...
public class EsGoodsCO  implements  Serializable{
    ...
    private List<EsGoodsSkuCO> skuList;
    ...
    private List<EsBuyerGoodsParamsDO> paramsList;
    ...
    @ApiModelProperty(value = "前端判断商品上下架状态 1上架 2下架")
    private Integer isMarketEnable;
