...
import com.shopx.goods.api.model.domain.EsSpecificationDO;
import com.shopx.goods.api.model.domain.dto.EsSpecificationDTO;
import com.shopx.goods.api.service.IEsSpecificationService;
 ...
 * @since 2019-06-03
 */
@Service(version = "${dubbo.application.version}", interfaceClass = IEsSpecificationService.class, timeout = 50000)
