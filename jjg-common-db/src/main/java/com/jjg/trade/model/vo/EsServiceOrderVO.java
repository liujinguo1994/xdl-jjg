...
public class EsServiceOrderVO extends Model<EsServiceOrderVO> {
	...
	private List<EsOrderItemsVO> esOrderItemsListDO;
	 ...
	 * 购物车SKU 集合
	 */
	@ApiModelProperty(value = "购物车SKU 集合")
	 ...
	 * 页面列表支付方式（买家端使用）
	 */
	@ApiModelProperty(value = "页面列表支付方式（买家端使用）")
