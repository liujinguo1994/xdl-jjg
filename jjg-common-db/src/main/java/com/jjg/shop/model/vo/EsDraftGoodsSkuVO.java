...
public class EsDraftGoodsSkuVO implements Serializable {
     ...
     * 真实库存(仓储系统可用库存)
     */
	@ApiModelProperty(value = "真实库存(仓储系统可用库存)")
	private Integer quantity;

    /**
     * 可用库存=真实库存+虚拟库存-冻结库存
     */
	@ApiModelProperty(value = "可用库存=真实库存+虚拟库存-冻结库存")
	 ...
	 * 商品相册集合
	 */
	@ApiModelProperty(value = "商品相册集合")
	private List<EsGoodsGalleryDTO> galleryList;
	/**
	 * 是否启用
	 */
	@ApiModelProperty(value = "是否启用 0 启用 1不启用 默认0")
	private Integer isEnable;
	/**
	 * 商品SKU预警值
	 */
	@ApiModelProperty(value = "商品SKU预警值")
	private Integer warningValue;
	/**
	 * 规格文本
	 */
	@ApiModelProperty(value = "规格文本")
