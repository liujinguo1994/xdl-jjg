...
public class EsMemberReceiptHistoryVO implements Serializable {
     ...
     * 发票id
     */
    @ApiModelProperty(required = false,value = "发票id",example = "1")
     ...
     * 发票金额
     */
    @ApiModelProperty(required = false,value = "发票抬头",example = "12.33")
     ...
     * 开票时间
     */
    @ApiModelProperty(required = false,value = "开票时间",example = "211111111")
     ...
     * 开票状态
     */
    @ApiModelProperty(required = false,value = "开票状态(1成功，2失败)")
